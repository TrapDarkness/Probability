...
def  dreamland(deck_size,  hand_size, desired_card_amount, copies_of_desired_cards):
    ...
    for i in copies_of_desired_cards:
        sum_desired_cards += copies_of_desired_cards[i]
    leftover_choices = math.comb(deck_size - sum_desired_cards, hand_size - sum_desired_cards)
    leftover_choices_mulligan = math.comb(deck_size - sum_desired_cards, hand_size - 1- sum_desired_cards)
    if 0 == 1:
